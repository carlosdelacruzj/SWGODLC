...
export class VisualizarService {
  ...
  public postPedido(EP_Cod:number,F_Registro:string, N_Pedido:number, Nombre :string, Apellido:string, Evento: String, Servicio: String,
    F_Evento:String, Hora_Evento:String, Direccion:string, Descripcion: Event): Observable<any> {
